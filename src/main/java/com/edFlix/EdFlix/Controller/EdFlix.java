...
import com.edFlix.EdFlix.Service.CoursePlaylist;
import com.edFlix.EdFlix.Service.UserEnrolledCourses;
import com.edFlix.EdFlix.Service.RegisterUser;
import com.edFlix.EdFlix.Service.VerifyUser;
...
public class EdFlix {
    ...
    public Map<String, String> registerUser(@RequestBody Map<String, Object> payload) {
...
//        SSAT
    ...
    public Map<String, Boolean> verifyUser(@RequestBody Map<String, Object> payload) {
    ...
    public Map<String, Set<String>> getUsersCourses(@RequestBody Map<String, Object> payload) {
...
//            if not it means the admin has not registered the user.
                Set<String> registeredCourses = uec.getEnrolledCourses(payload, this.ref).get();
                return new HashMap<>() {
                    {
    ...
    @PostMapping("/course")
    public Map<String, List<Map<String, String>>> getCourse(@RequestBody Map<String, Object> payload) {
        CompletableFuture<List<String>> future;
        boolean result = false;
        Map<String, Object> _payload_ = (Map<String, Object>) payload.get("payload");
        try {
            result = ver.verify(
                    new HashMap<>() {
                        {
                    ...
                    }, this.ref).get(); // wait for CompletableFuture
        } catch (
                Exception e) {
            e.printStackTrace();
        }
...
//                Check if user is enrolled in this course.
                Boolean cf = uec.isEnrolled(playlist, this.ref, (ArrayList<String>) _payload_.get("tokens")).get();
                return new HashMap<>() {
                    {
